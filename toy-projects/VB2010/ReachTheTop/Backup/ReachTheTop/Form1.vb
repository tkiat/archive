...
Public Class ReachTheTop
    ...
    Dim Score As Double = 490
    Dim Death As Boolean
    Dim PointMoveOld As Integer
    Dim BlockSpeed As Integer = 3
    ...
    End Sub
    Function iscollideBlock(ByVal PersonX As Integer, ByVal PersonY As Integer, ByVal TekiX As Integer, ByVal TekiY As Integer, ByVal PersonWidth As Integer, ByVal TekiWidth As Integer)
        Dim Fact As Boolean
    ...
    Function IsCollide(ByVal Unit As Object)
        Dim Fact As Boolean
        Fact = iscollideBlock(Person.Location.X, Person.Location.Y, Unit.Location.X, Unit.Location.Y, Person.Width, Unit.Width)
        Return Fact
    End Function
