...
Public Class MarioJump
    ...
    Private Sub Begin()
        ...
        If (StageNumber = 1) Then
            StageBegin(Color.FromArgb(128, 64, 0), 0, 0, "C:\Users\VAIO\Desktop\MarioJump\field.wav")
        End If
        If (StageNumber = 2) Then
            Teki1.BackgroundImage = TekiRight.BackgroundImage
            StageBegin(Color.BlueViolet, 0, 0, "C:\Users\VAIO\Desktop\MarioJump\dungeon.wav")
            End If
        If (StageNumber = 3) Then
            TekiSpeed += 1
            Teki1.BackgroundImage = TekiLeft.BackgroundImage
            StageBegin(Color.Orange, 20, 20, "C:\Users\VAIO\Desktop\MarioJump\field.wav")
        End If
            If (StageNumber = 4) Then
            StageBegin(Color.Fuchsia, 30, 20, "C:\Users\VAIO\Desktop\MarioJump\castle.wav")
                TekiSpeed = 0
    ...
    Private Sub Death()
        ...
        My.Computer.Audio.Play("C:\Users\VAIO\Desktop\MarioJump\death.wav", AudioPlayMode.Background)
    ...
    Private Sub tmrControl_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrControl.Tick
        ...
        If IsCollide(Trophy) Then
            ...
            CloseTimers(True)
            My.Computer.Audio.Stop()
            My.Computer.Audio.Play("C:\Users\VAIO\Desktop\MarioJump\goal.wav", AudioPlayMode.Background)
            InitialTime = 0
            Stage.Value = 0
            StageNumber += 1
            Trophy.Location = New Point(600, 25)
    ...
    Private Sub tmrBlockMove_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrBlockMove.Tick
        ...
        ElseIf (StageNumber = 3) Then
            Shift(Teki1, -TekiSpeed, -TekiSpeed / 4)
            If (Teki1.Location.X < -50) Then
                Teki1.BackgroundImage = TekiRight.BackgroundImage
                TekiSpeed -= 2 * TekiSpeed
                Teki1.Location = New Point(0, Fix(Rnd() * 200))
            ElseIf (Teki1.Location.X > 530) Then
                Teki1.BackgroundImage = TekiLeft.BackgroundImage
                TekiSpeed -= 2 * TekiSpeed
                Teki1.Location = New Point(530, Fix(Rnd() * 200 + 50))
            End If
        End If
        Randomize()
    ...
    Private Sub tmrBlockShift_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrBlockShift.Tick
        ...
        If (StageNumber = 1) Then
            BlockSpeed = Fix(Stage.Value / 17) + 1
        ElseIf (StageNumber = 2 Or StageNumber = 3) Then
            BlockSpeed = Fix(Stage.Value / 16) + 2
    ...
    Private Sub tmrCredit_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrCredit.Tick
        ...
        Else
            ...
            My.Computer.Audio.Play("C:\Users\VAIO\Desktop\MarioJump\555.wav", AudioPlayMode.Background)
        End If
    End Sub
End Class
