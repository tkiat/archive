/* usage
<nav-main font='your font'></nav-main>
*/
class NavMain extends HTMLElement {
	...
	*, *::before, *::after {
	...
	header {
		font-family:  '${this.getAttribute('font')}', sans-serif;
		background: #8E18D6;
		text-align: center;
		position: fixed;
		z-index: 999;
	...
	<header>
		<a href="/"><img class="logo" src='${this.getAttribute('img-logo')}' alt="LOGO"></a>
...
window.customElements.define('nav-custom', CustomTitle)
*/
